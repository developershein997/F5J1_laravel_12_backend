...
Route::group([
    ...
    Route::get('change-password/{user}', [App\Http\Controllers\Admin\LoginController::class, 'showChangePassword'])->name('change-password');
    Route::post('update-password/{user}', [App\Http\Controllers\Admin\LoginController::class, 'updatePassword'])->name('update-password');
});
